...
--> statement-breakpoint
ALTER TABLE "supplier_invoice_files" ADD CONSTRAINT "supplier_invoice_files_invoice_id_supplier_invoices_id_fk" FOREIGN KEY ("invoice_id") REFERENCES "public"."supplier_invoices"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
